...
import 'add_activity.dart'; // Pastikan mengimpor halaman input Anda
      ...
      body: Padding(
        ...
        child: GridView.builder(
          ...
          gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
            crossAxisCount: 2, // Mengatur agar menjadi 2 kolom menyamping
            crossAxisSpacing: 12, // Jarak horizontal antar kotak
            mainAxisSpacing: 12, // Jarak vertikal antar kotak
            childAspectRatio: 1.1, // Rasio tinggi & lebar kotak
          ),
          ...
          itemBuilder: (context, index) {
            ...
            return InkWell(
              onTap: () {
                // 3. Aksi saat kategori diklik:
                // Pindah ke halaman input dan bawa data kategori

                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => AddActivityScreen(
                      kategoriPilihan: item["nama"],
                    ),
                  ),
                ).then((dataBaru) {

                  // Jika dari halaman input mengirim data transaksi baru,
                  // langsung lempar balik ke Home
