...
class _AddActivityScreenState extends State<AddActivityScreen> {
  ...
  final TextEditingController _controllerKegiatan =
      TextEditingController();

  final TextEditingController _controllerNominal =
      TextEditingController();
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Tampilkan kategori yang dipilih dari halaman sebelumnya
            Container(
                ...
                onPressed: () {
                  ...
                  if (_controllerKegiatan.text.isNotEmpty &&
                    ...
                    Map<String, dynamic> dataBaru = {
                      ...
                      "nominal":
                          int.parse(_controllerNominal.text),
                      "kategori":
                          widget.kategoriPilihan,
                    };
